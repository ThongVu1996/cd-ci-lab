...
* **CI/CD Tooling:**  
  ![pipe-line-CI-CD](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/pipeline.png)
...
![check-cloud-flare-agent-in-local](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/check-cloud-flare-agent-in-local.png)
...
![check ingress-nginx in local](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/check-ingress-nginx-local.png)
...
![config-cloud-flare-tunel](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/token-cloud-flare-tunel.png)
...
![blue-ocean](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/blue-ocean.png)

Kết quả build thành công:

![jenkins-build](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/jenkins-build.png)
...
![harbor-project](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/harbor-project.png)

Danh sách Images:

![harbor-images](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/harbor-images.png)

Chi tiết Platform:

![multilpe-plate-form](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/multilpe-plate-form.png)
...
![ECR-list-repo](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/ECR-list-repo.png)
...
![manifest-cloud](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/manifest-cloud.png)

File values cấu hình:

![mainifest-values-config](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/mainifest-values-config.png)
...
![argocd-local-app](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/argocd-local-app.png)

Chi tiết đồng bộ:

![argocd-local-app-detail](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/argocd-local-app-detail.png)

**Bước 4: Truy cập ứng dụng**

* Trường hợp thành công:
  
![app-local-success](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/app-local-success.png)

* Trường hợp thất bại:

![app-local-fail](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/app-local-fail.png)
...
![log-app-local](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/log-app-local.png)
...
* **Kết quả**:
  ...
  ![RDS](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/RDS.png)
...
![address-aws-alb](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/address-aws-alb.png)
...
![change-subdomain-local](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/change-subdomain-local.png)

![results-change-subdomain](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/results-change-subdomain.png)
...
![link-app-die](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/link-app-die.png)
...
![record-for-aws](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/record-for-aws.png)

![record-for-aws-1](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/record-for-aws-1.png)
...
![results-app-aws-1](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/results-app-aws-1.png)

![results-app-aws-2](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/results-app-aws-2.png)
...
![confirm-connect-aws](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/confirm-connect-aws.png)
...
![aws-logs](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/aws-logs.png)
...
![frontend-pod](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/frontend-pod.png)
...
* Triển khai (Mô hình Sidecar):  
  ...
  * **Trên ArgoCD/Kubernetes:** Bạn sẽ thấy Pod Backend có trạng thái **2/2** (Ready/Total). Điều này nghĩa là trong 1 Pod đang chạy song song 2 Containers:  
  ...
  ![backend-pod](https://github.com/ThongVu1996/cd-ci-lab/blob/master/final/backend-pod.png)
